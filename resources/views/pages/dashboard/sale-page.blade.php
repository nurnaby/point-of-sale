...
@section('content')
                            ...
                            <div class="col-12">
                                ...
                                <p>
                                    <button onclick="createInvoice()"
                                        class="btn  my-3 btn btn-primary w-40">Confirm</button>
                                </p>
                            </div>
    ...
    <script>
        ...
        function ShowInvoiceItem() {
            ...
            InvoiceItemList.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-index="${index}" class="btn remove badge bg-danger">Remove</a></td>
                     </tr>`
        ...
        async function CustomerList() {
            ...
            res.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-email="${item['email']}" data-id="${item['id']}" class="btn btn-outline-success px-1 addCustomer  text-xxs px-2 py-1  btn-sm m-0">Add</a></td>
                     </tr>`
        ...
        async function ProductList() {
            ...
            res.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        <td> <img style="width: 60px; height:40px" src="${item['img_url']}"/> ${item['name']} ($ ${item['price']})</td>
